...
class Exaone4_5_TextConfig(PreTrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Exaone4_5_TextModel`]. It is used to
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 102400):
            ...
            `inputs_ids` passed when calling [`Exaone4_5_TextModel`].
...
__all__ = ["Exaone4_5_Config", "Exaone4_5_TextConfig"]
